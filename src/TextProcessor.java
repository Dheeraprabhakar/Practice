...
public class TextProcessor {
    ...
    public static void main(String args[]){
        ...
        int width = readIntInput(sc,"width", input, largestStr);

        System.out.println("Enter the alignment from below \n1. CENTER \n2. LEFT \n3. RIGHT \n4. HARD");


        int alignment = readIntInput(sc,"alignment", input, largestStr);
    ...
    private static int readIntInput(Scanner sc, String option, String input, int longestStrLen) {
